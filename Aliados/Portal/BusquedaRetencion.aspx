<%@ Page Title="" Language="C#" MasterPageFile="~/Portal/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="BusquedaRetencion.aspx.cs" Inherits="PortalTrabajadores.Portal.BusquedaRetencion" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
                ...
                <Columns>
                    <asp:BoundField DataField="D_25" HeaderText="Cedula" />
                    <asp:TemplateField HeaderText="Generar" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:ImageButton ID="Imgpdf" runat="server" ImageUrl="~/Img/pdf.gif" CommandName="Comprobante" />
                        </ItemTemplate>
