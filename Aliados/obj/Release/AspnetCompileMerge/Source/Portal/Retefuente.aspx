<%@ Page Title="" Language="C#" MasterPageFile="~/Portal/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="Retefuente.aspx.cs" Inherits="PortalTrabajadores.Portal.Cerlaboral" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" GridLines="Vertical" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
                ...
                <Columns>
                    <asp:BoundField DataField="anio_Retefuente" HeaderText="Año" >
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                    </asp:BoundField>
                    <asp:TemplateField HeaderText="Descargar" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:ImageButton ID="Imgpdf" runat="server" ImageUrl="~/Img/pdf.gif" CommandArgument='<%#Eval("idRetefuente") %>' CommandName="PDF" />
                        </ItemTemplate>
