...
namespace PortalTrabajadores.Portal
{
    public partial class login : System.Web.UI.Page
    {
        ...
        protected void btnlogin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                MySqlCommand scSqlCommand = new MySqlCommand("SELECT Nit_Tercero, Id_Rol, Razon_social FROM trabajadores.terceros JOIN trabajadores.companias as a ON Nit_Tercero = a.Terceros_Nit_Tercero where Nit_Tercero = '" + this.txtuser.Text + "' and Contrasena_tercero = '" + this.txtPass.Text + "' and activo_tercero = '1' and Activo_Compania = 1 and Empresas_idEmpresa = 'AE'", MySqlCn);
