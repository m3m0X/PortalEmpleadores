    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div id="Container_UpdatePanel2" runat="server" visible="false">
                ...
                <table id="TablaDatos">
                    <tr>
                        <th colspan="2">Asignar Competencia al cargo
                            <asp:Label ID="lblCargoSelected" runat="server"></asp:Label></th>
                    </tr>
                    <tr class="ColorOscuro">
                        <td class="CeldaTablaDatos">Seleccione la competencia
                        </td>
                        <td class="BotonTablaDatos">
                    ...
                    <tr>
                        <td class="CeldaTablaDatos">Seleccione el nivel de la competencia
                        </td>
                        <td class="BotonTablaDatos">
                    ...
                    <tr class="ColorOscuro">
                        ...
                        <td class="BotonTablaDatos">
                            <asp:Button ID="BtnCancelar" runat="server" Text="Cerrar" OnClick="BtnCancelar_Click" /></td>
                    </tr>
                </table>
            </div>
