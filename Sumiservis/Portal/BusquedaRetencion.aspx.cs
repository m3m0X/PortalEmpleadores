        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!IsPostBack)
                {
                    ...
                    try
                    {
                        MySqlCommand scSqlCommand = new MySqlCommand("SELECT descripcion FROM basica_trabajador.Options_Menu WHERE url = 'BusquedaRetencion.aspx' AND idEmpresa = 'SS'", Conexion.ObtenerCnMysql());
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (txtuser.Text != string.Empty)
            {
                ...
                try
                {
                    ...
                    cmd.Parameters.AddWithValue("@id_Empresa", "SS");
