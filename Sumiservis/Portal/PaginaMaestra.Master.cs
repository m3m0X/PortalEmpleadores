    ...
    public partial class PaginaMaestra : System.Web.UI.MasterPage
    {
        ...
        protected void Navigation_MenuItemClick(object sender, MenuEventArgs e)
        {
            switch (e.Item.Text)
            {
                ...
                case "Atras":
                    Session["Menu"] = null;
                    bindMenuControl2();
                    Response.Redirect("/SumiservisEmpleadores/Portal/index.aspx");
                    return;
            }
        }
        #endregion
        ...
        protected void bindMenuControl(Boolean valor)
        {
            if (valor)
            {
                ...
                MySqlCommand scSqlCommand = new MySqlCommand("SELECT idOption_Menu, descripcion, idparent_option_Menu, url FROM basica_trabajador.Options_Menu WHERE idEmpresa = 'SS' and TipoPortal = 'E'", MySqlCn);
        ...
        {
                MySqlCn = new MySqlConnection(Cn);
                MySqlCommand scSqlCommand = new MySqlCommand("SELECT idOption_Menu, descripcion, idparent_option_Menu, url FROM basica_trabajador.Options_Menu WHERE idEmpresa = 'SS' and TipoPortal = 'E' and idOption_Menu=105", MySqlCn);
                MySqlDataAdapter sdaSqlDataAdapter = new MySqlDataAdapter(scSqlCommand);
                DataSet dsDataSet = new DataSet();
                DataTable dtDataTable = null;
                try
