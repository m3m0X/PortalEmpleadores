    ...
    public partial class PaginaMaestra : System.Web.UI.MasterPage
    {
        ...
        protected void bindMenuControl(Boolean valor)
        {
            if (valor)
            {
                ...
                MySqlCommand scSqlCommand = new MySqlCommand("SELECT idOption_Menu, descripcion, idparent_option_Menu, url FROM " + bd1 + ".Options_Menu WHERE idEmpresa = 'SS' and TipoPortal = 'E'", MySqlCn);
        ...
        {
                MySqlCn = new MySqlConnection(Cn);
                MySqlCommand scSqlCommand = new MySqlCommand("SELECT idOption_Menu, descripcion, idparent_option_Menu, url FROM " + bd1 + ".Options_Menu WHERE idEmpresa = 'SS' and TipoPortal = 'E' and idOption_Menu=105", MySqlCn);
                MySqlDataAdapter sdaSqlDataAdapter = new MySqlDataAdapter(scSqlCommand);
                DataSet dsDataSet = new DataSet();
                DataTable dtDataTable = null;
                try
