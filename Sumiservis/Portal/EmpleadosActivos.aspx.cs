            ...
            else
            {
                if (!IsPostBack)
                {
                    try
                    {
                        ...
                        MySqlCommand scSqlCommand = new MySqlCommand("SELECT descripcion FROM Options_Menu WHERE url = 'EmpleadosActivos.aspx' AND idEmpresa = 'SS'", MySqlCn);
                ...
                try
                {
                    ...
                    MySqlCommand scSqlCommand = new MySqlCommand("SELECT trabajadores.empleados.Id_Empleado AS Cedula, " +
                                                                    ...
                                                                    "where trabajadores.empleados.Companias_idEmpresa = 'SS' AND  " +
