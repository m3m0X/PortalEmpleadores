<%@ Page Title="" Language="C#" MasterPageFile="~/Portal/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="Conductas.aspx.cs" Inherits="PortalTrabajadores.Portal.Conductas" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div id="Container_UpdatePanel1" runat="server" visible="false">
                <asp:GridView ID="gvConductasCreadas" runat="server" 
                    OnRowDataBound="gvConductasCreadas_RowDataBound"
                    OnRowCommand="gvConductasCreadas_RowCommand" 
                    OnPageIndexChanging="gvConductasCreadas_PageIndexChanging" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Acciones" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:ImageButton ID="btnUpdate" runat="server" ImageUrl="~/Img/edit.gif" CommandArgument='<%#Eval("idConducta")%>' CommandName="Editar" />
                                <asp:ImageButton ID="btnON" runat="server" ImageUrl="~/Img/on.png" CommandArgument='<%#Eval("idConducta")%>' CommandName="On" />
                                <asp:ImageButton ID="btnOFF" runat="server" ImageUrl="~/Img/off.png" CommandArgument='<%#Eval("idConducta")%>' CommandName="Off" />
                            </ItemTemplate>
                ...
                <br />
                <asp:Button ID="BtnConductas" runat="server" Text="Crear Conductas" OnClick="BtnConductas_Click"  />
            ...
            <div id="Container_UpdatePanel2" runat="server" visible="false">
                ...
                <table id="TablaDatos">
                    <tr>
                        <th colspan="2">Digite la conducta</th>
                    </tr>
                    <tr class="ColorOscuro">
                        <td class="CeldaTablaDatos">
                            <asp:Label ID="lblConducta" runat="server" Text="Conducta:" />
                        </td>
                        <td class="BotonTablaDatos">
                            <asp:TextBox ID="txtConducta" runat="server"
                    ...
                    <tr class="ColorOscuro">
                        <td colspan="2">
                            <asp:RequiredFieldValidator ID="rfvConducta"
                                runat="server"
                                ErrorMessage="Debe digitar una conducta"
                                CssClass="MensajeError"
                                Display="Dynamic"
                                ControlToValidate="txtConducta"
        ...
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="BtnConductas" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
