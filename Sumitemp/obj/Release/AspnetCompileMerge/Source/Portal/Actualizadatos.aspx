    ...
    <div id="Container_UpdatePanel1">
        <table id="TablaDatos">
            ...
            <tr class="ColorOscuro">
                ...
                <td><asp:TextBox ID="TxtNombres" runat="server" MaxLength="100" onkeypress="return ValidaSoloLetras(event)"/></td>
            </tr>
            <tr>
                <td><asp:Label ID="LblPrimerApellido" runat="server" Text="Primer apellido:" /></td>
                <td><asp:TextBox ID="TxtPrimerApellido" runat="server" MaxLength="100" onkeypress="return ValidaSoloLetras(event)"/></td>
            </tr>
            <tr class="ColorOscuro">
                <td><asp:Label ID="LblSegundoApellido" runat="server" Text="Segundo apellido:" /></td>
                <td><asp:TextBox ID="TxtSegundoApellido" runat="server" MaxLength="100" onkeypress="return ValidaSoloLetras(event)"/></td>
            </tr>
            <tr>
            ...
            <tr class="ColorOscuro">
                ...
                <td><asp:TextBox ID="TxtLugarNac" runat="server" MaxLength="45" onkeypress="return ValidaSoloLetras(event)"/></td>
            </tr>
            <tr>
            ...
            <tr class="ColorOscuro">
                ...
                <td><asp:TextBox ID="TxtDir" runat="server" MaxLength="100" /></td>
            </tr>
            <tr>
                <td><asp:Label ID="LblBarrio" runat="server" Text="Barrio:" /></td>
                <td><asp:TextBox ID="TxtBarrio" runat="server" MaxLength="45" onkeypress="return ValidaSoloLetras(event)"/></td>
            </tr>
            <tr class="ColorOscuro">
            ...
            <tr class="ColorOscuro">
                ...
                <td><asp:TextBox ID="TxtEps" runat="server" MaxLength="50" /></td>
            </tr>
            <tr>
                <td><asp:Label ID="LblAfp" runat="server" Text="AFP:" /></td>
                <td><asp:TextBox ID="TxtAfp" runat="server" MaxLength="50" /></td>
            </tr>
            <tr class="ColorOscuro">
                <td><asp:Label ID="LblCesantias" runat="server" Text="Fondo Cesantias:" /></td>
                <td><asp:TextBox ID="TxtCesantias" runat="server" MaxLength="50" /></td>
            </tr>
            <tr>
