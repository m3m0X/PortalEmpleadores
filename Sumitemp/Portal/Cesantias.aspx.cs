    ...
    public partial class Estadocesantias : System.Web.UI.Page
    {
            ...
            else
            {
                if (!IsPostBack)
                {
                    try
                    {
                        ...
                        MySqlCommand scSqlCommand = new MySqlCommand("SELECT descripcion FROM Options_Menu WHERE url = 'Cesantias.aspx' AND idEmpresa = 'ST'", MySqlCn);
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            SqlDataSource1.SelectCommand = "SELECT idCesantia, anio_cesantia, Mes_Cesantia, ruta_archivo_cesantia as ruta, " +
                                            ...
                                            "trabajadores.companias.idcompania = trabajadores.empleados.companias_idcompania LIMIT 1";
            try
            {
