    ...
    public partial class ComprobanteNomina : System.Web.UI.Page
    {
            ...
            else
            {
                if (!IsPostBack)
                {
                    try
                    {
                        ...
                        MySqlCommand scSqlCommand = new MySqlCommand("SELECT descripcion FROM Options_Menu WHERE url = 'ComprobanteNomina.aspx' AND idEmpresa = 'ST'", MySqlCn);
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Etemporal", Session["idEmpresa"].ToString());
