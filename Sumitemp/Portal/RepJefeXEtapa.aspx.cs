...
{
    public partial class RepJefeXEtapa : System.Web.UI.Page
    {
            ...
            else
            {
                if (!IsPostBack)
                {
                    try
                    {
                        ...
                        MySqlCommand scSqlCommand = new MySqlCommand("SELECT descripcion FROM Options_Menu WHERE url = 'RepJefeXEtapa.aspx' AND idEmpresa = 'ST'", MySqlCn);
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MySqlCommand scSqlCommand = new MySqlCommand(bd3 + ".sp_EstadoJefeEtapa", MySqlCn);
                ...
                if (dtDataTable != null && dtDataTable.Rows.Count > 0)
                {
                    ...
                    httpResponse.AddHeader("content-disposition", "attachment;filename=\"EstadoJefeEtapa.xlsx\"");
