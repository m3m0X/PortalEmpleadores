                    ...
                    try
                    {
                        ...
                        if (dtDataTable != null && dtDataTable.Rows.Count > 0)
                        {
                            ...
                            else
                            {
                                ...
                                string command = "SELECT idCompania, Descripcion_compania FROM trabajadores.companias where Empresas_idempresa = '" + Session["idEmpresa"].ToString() + "' and activo_compania = 1 and Terceros_Nit_Tercero =" + Session["usuario"];
